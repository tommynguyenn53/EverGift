...
export default function HowEverGiftWorksCard() {
    return (
        <div
            className="w-[342px] md:w-[513px] bg-white rounded-[10px] md:rounded-[15px] flex flex-col gap-[22px]
            md:gap-[33px] py-[22px] px-[17px] md:py-[33px] md:px-[26px] mt-[48px] md:mt-[72px] shadow-[0px_3px_12px_rgba(0,0,0,0.1)]"
        >
            {/* Title */}
            <h2
                className="font-inter font-semibold text-[20px] md:text-[30px] text-[#3A3A3A] text-center"
            >
                How EverGift Works
            </h2>
            ...
            {/* Bottom section */}
            <div
                className="flex flex-row gap-[17px] md:gap-[25.5px] items-center"
            >
                {/* Icons column */}
                <div
