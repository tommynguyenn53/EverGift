      ...
      "
        ...
        "
            ...
            >
                ...
                <p className="font-inter text-[11px] leading-[150%] tracking-[0.015em] text-[#3A3A3A]">
                    We suggest creating your collage using a design tool, then uploading the final image:
                </p>

                <ul className="list-disc pl-[16px] space-y-[6px] font-inter text-[11px] leading-[150%] tracking-[0.015em] text-[#3A3A3A]">
                    <li>
                        <a
