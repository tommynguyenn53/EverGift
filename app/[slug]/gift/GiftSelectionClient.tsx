...
import GiftAcknowledgementModal from '@/components/GiftAcknowledgementModal'
                        ...
                        <div className="flex flex-col gap-[12px] md:gap-[18px]">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="font-inter text-[11px] md:text-[16.5px] text-[#C9A86A] hover:opacity-80"
                                >
                                    Remove
                                </button>
                            </div>

                            <div className="flex justify-center mt-[6px] md:mt-[9px]">
                                <PortraitUploadTile
