                ...
                >
                    ...
                    <div className="mt-[40px] md:mt-[60px] w-[298px] md:w-[447px]">
                        ...
                        <input
                            ...
                            text-[#3A3A3A] placeholder:text-[#3A3A3A]/35 transition focus:outline-none focus:ring-2
                        ...
                        <p
                            ...
                            tracking-[0.015em]
                            ${
                                passwordValid ? 'text-green-600' : 'text-[#3A3A3A]'
                            }
                        `}
                        >
                    ...
                    <div className="mt-[40px] md:mt-[60px] w-[298px] md:w-[447px]">
                        ...
                        {confirmPassword.length > 0 && (
                            <p
                                ...
                                tracking-[0.015em]
                                ${
                                    passwordsMatch ? 'text-green-600' : 'text-[#3A3A3A]'
                                }
                            `}
                            >
                    ...
                    <button
                        ...
                        font-medium text-[16px] md:text-[24px] text-white transition disabled:opacity-60
                        disabled:cursor-not-allowed hover:opacity-90 active:opacity-80 active:scale-[0.98]"
                    >
